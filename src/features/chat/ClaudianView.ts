...
import { isWriteEditTool, TOOL_AGENT_OUTPUT, TOOL_BASH, TOOL_TASK, TOOL_TODO_WRITE } from '../../core/tools/toolNames';
import {
  type ChatMessage,
  type ClaudeModel,
  type Conversation,
...
export class ClaudianView extends ItemView {
  ...
  private async sendMessage(options?: { editorContextOverride?: EditorSelectionContext | null }): Promise<void> {
    ...
    let queryOptions: { allowedTools?: string[]; model?: string; mcpMentions?: Set<string>; enabledMcpServers?: Set<string> } | undefined;
    ...
    const mcpMentions = this.plugin.mcpService.extractMentions(promptToSend);
